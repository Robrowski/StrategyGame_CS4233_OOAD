 ...
 */
public class EpsilonPieceMoves implements IPieceMoves {

	/* (non-Javadoc)
	 * @see game.version.common.IPieceInfo#getMovementCapability(game.common.PieceType)
	 */
	public int getMovementCapability(PieceType type) {
		...
		if (type.equals(PieceType.FIRST_LIEUTENANT)) return 1;
