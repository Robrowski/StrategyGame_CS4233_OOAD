...
public class GammaPieceLocationValidator  extends AbstractPieceLocationValidator  {
	...
	/* (non-Javadoc)
	 * @see game.version.common.validation.configuration.location.AbstractPieceLocationValidator#isPlayerColorExpected(common.PlayerColor)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see game.version.common.validation.configuration.location.AbstractPieceLocationValidator#generateValidStartingLocations(common.PlayerColor)
	 */
	@Override
