...
import game.version.epsilon.EpsilonPieceMoves;
import game.version.epsilon.EpsilonPiecePowers;
...
public class EpsilonStrategyGameControllerTest {
	...
	public void makeMoveBeforeInitialization() throws StrategyException	{
		final GameController agame = GameFactory.getInstance().makeEpsilonStrategyGame(validRedConfiguration, validBlueConfiguration, observers);
