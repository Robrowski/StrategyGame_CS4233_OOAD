...
public class GammaStrategyGameControllerTest {
	...
	private final Location L22_cp = new Location2D(2, 2); // choke point
	private final Location L32_cp = new Location2D(3, 2); // choke point
	...
	private final Location L23_cp = new Location2D(2, 3); // choke point
	private final Location L33_cp = new Location2D(3, 3); // choke point
	...
	public void setup() throws StrategyException{
		...
		// Fresh valid game
		game = factory.makeGammaStrategyGame(validRedConfiguration, validBlueConfiguration);
		game.startGame();
	...
	public void nullRedConfiguration() throws StrategyException{
		factory.makeGammaStrategyGame(null, validBlueConfiguration);
	}
	...
	public void nullForBlueConfiguration() throws StrategyException{
		factory.makeGammaStrategyGame(validRedConfiguration, null);
	}
	...
	public void tooFewPiecesForBlueConfigurationButHasFlag() throws StrategyException{
		...
		factory.makeGammaStrategyGame(validRedConfiguration, badConfig);
	}
	...
	/////////// TESTING makeGammaStrategyGame -- locations
	/**
	...
	public void getPieceAtChokePoints() throws StrategyException{
		assertSame(chokePoint.getType(), game.getPieceAt(L33_cp).getType() );
		assertSame(chokePoint.getType(), game.getPieceAt(L32_cp).getType() );
	...
	public void makeMoveBeforeInitialization() throws StrategyException	{
		final StrategyGameController agame = StrategyGameFactory.getInstance().makeGammaStrategyGame(validRedConfiguration, validBlueConfiguration);
	...
	public void moveOffBoardXPositive() throws StrategyException {
		game.move(PieceType.SERGEANT, L51 ,  new Location2D(6, 1));			
	}
	...
	public void moveOffBoardYPositive() throws StrategyException {
		game.move(PieceType.SERGEANT, L51 ,  validMove_RedSerg3);
		game.move(PieceType.MARSHAL, L55 ,  new Location2D(5, 6));
	}
